...
public protocol PopupPresentable: class {
    ...
    func showPopupView(duration: TimeInterval, curve: UIView.AnimationCurve, delayFactor: CGFloat)
    func transformPopupView(duration: TimeInterval, curve: UIView.AnimationCurve, popupItem: PopupItem, completion: @escaping ((UIViewAnimatingPosition) -> Void))
    func dismissPopupView(duration: TimeInterval, curve: UIView.AnimationCurve, delayFactor: CGFloat, direction: PopupViewDirection, completion: @escaping ((UIViewAnimatingPosition) -> Void))
}
